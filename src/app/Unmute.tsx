...
import { IntiTextChat } from "./components/IntiTextChat";
...
const Unmute = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative flex w-full min-h-screen flex-col text-gray-800 items-center" style={{background: 'var(--background)'}}>
        ...
        >
          ...
          <PositionedAudioVisualizer
            ...
            profileImageUrl={user?.profileImage || null} // Pass user profile image
          />
        </div>
      ...
      />
      {/* Live Text Display */}
      {false {false && showLiveText && ({false && showLiveText && ( (
