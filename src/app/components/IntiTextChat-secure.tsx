...
export const IntiTextChatSecure: React.FC<IntiTextChatProps> = ({
  isVisible,
  onClose,
  topicUuid
}) => {
        ...
        case "text_chat.message":
          ...
          if (message.data?.content) {
            ...
            if (memoryChat && topicUuid) {
              memoryChat.addMessage(message.data.content, "assistant").then(result => {
...
export default IntiTextChatSecure;